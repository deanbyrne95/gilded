...
document.addEventListener("click",(e)=>{
  ...
  switch(a){
    ...
    case "ng-mode": SETTINGS.mode=t.dataset.mode; saveSettings(); ngNext(); break;
    ...
    case "ng-players": captureNames(); SETTINGS.humans=+t.dataset.v; saveSettings(); ngRerender(); break;
    case "ng-watchers": SETTINGS.watchers=+t.dataset.v; saveSettings(); ngRerender(); break;
    case "ng-win": SETTINGS.maxVP=+t.dataset.v; saveSettings(); ngRerender(); break;
    ...
    case "del-session": askDeleteSession(t.dataset.id); break;
    case "del-confirm": deleteSession(t.dataset.id); sessRerender(); break;
    case "del-cancel": delConfirmId=null; sessRerender(); break;
